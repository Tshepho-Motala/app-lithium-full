...
angular.module('lithium')
	.controller('ReportIncompletePlayersList', ["notify", "$state", "$rootScope", "$dt", "$translate", "$uibModal",
	function(notify, $state, $rootScope, $dt, $translate, $uibModal) {
		var controller = this;
		
		var baseUrl = "services/service-report-incomplete-players/report/players/list/table?1=1";
...
//						return $userService.domainsWithRole("report_incompleteplayers");
//					},
