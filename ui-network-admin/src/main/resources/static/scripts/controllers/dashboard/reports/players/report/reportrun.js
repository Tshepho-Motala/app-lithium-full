...
angular.module('lithium')
	.controller('ReportRunPlayers', ["$scope", "notify", "$state", "$rootScope", "$dt", "$translate", "bsLoadingOverlayService", "ReportPlayersRest", 
	function($scope, notify, $state, $rootScope, $dt, $translate, bsLoadingOverlayService, ReportPlayersRest) {
		let controller = this;
		...
		let baseUrl = "services/service-report-players/report/players/" + reportId + "/runs/" + reportRunId + "/results/table";
		...
		controller.downloadxls = function() {
			window.location = 'services/service-report-players/report/players/'+reportId+'/runs/'+reportRunId+'/xls?accessKey='
