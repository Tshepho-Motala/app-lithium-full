...
angular.module('lithium').controller('GoGameTutorialsAddController', ['$translate', '$uibModal', '$userService', '$filter', '$state', '$scope', 'errors', 'notify', '$q', 'GoGameGamesRest',
...
//				}
		...
		controller.onSubmit = function() {
			...
			gogameGamesRest.addTutorial(controller.model).then(function(response) {
				console.log(response);
				if (response._status === 0) {
					notify.success('Successfully added tutorial');
					$state.go("dashboard.gogamegames.tutorials.tutorial", { id:response.id });
				} else {
