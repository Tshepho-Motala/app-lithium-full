...
angular.module('lithium').controller('GoGameResultBatchesAddController', ['$translate', '$uibModalInstance', '$filter', '$state', '$scope', 'errors', 'notify', '$q', 'GoGameGamesRest',
...
//				}
		...
		controller.onSubmit = function() {
			...
			gogameGamesRest.addResultBatch(controller.model).then(function(response) {
				if (response._status === 0) {
					notify.success('Result batch added successfully. Processing for generating results will begin shortly');
				...
				notify.error('Result batch could not be added');
