...
angular.module('lithium')
	.controller('ViewNotification', ["$uibModalInstance", "$userService", "notify", "errors", "LeaderboardRest", "NotificationRest", "$translate", "rest-casino", "leaderboard", "notification",
	function($uibModalInstance, $userService, notify, errors, leaderboardRest, notificationRest, $translate, restCasino, leaderboard, notification) {
		var controller = this;
		...
		controller.onSubmit = function() {
			...
			leaderboardRest.editNotification(controller.model.leaderboard.id, controller.model.id, controller.model.bonusCode, controller.model.notification, controller.model.rank).then(function(c) {
				console.log(c);
				if (c._successful) {
					notify.success("UI_NETWORK_ADMIN.LEADERBOARD.NOTIFICATION.EDIT.SUCCESS");
					$uibModalInstance.close(c);
				} else {
					notify.error("UI_NETWORK_ADMIN.LEADERBOARD.NOTIFICATION.EDIT.ERROR");
				}
			}).catch(function(error) {
				console.error(error);
				notify.error("UI_NETWORK_ADMIN.LEADERBOARD.NOTIFICATION.EDIT.ERROR");
