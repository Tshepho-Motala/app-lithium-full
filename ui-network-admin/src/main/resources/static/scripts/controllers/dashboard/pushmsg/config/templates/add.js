...
angular.module('lithium')
	.controller('TemplateAdd', ["domainName", "$uibModalInstance", "PushMsgTemplateRest", "notify", "errors", "$q",
			...
			asyncValidators: {
				nameUnique: {
					expression: function($viewValue, $modelValue, scope) {
						var success = false;
						return rest.findByNameAndDomainName(encodeURIComponent($viewValue), domainName).then(function(pushmsgTemplate) {
...
//		},
		{
			className: "col-xs-12",
			key: "current.providerTemplateId",
			type: "input",
