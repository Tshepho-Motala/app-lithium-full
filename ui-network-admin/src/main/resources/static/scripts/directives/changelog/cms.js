...
angular.module('lithium').directive('cmsChangelog', function() {
    return {
        restrict: 'E',
        templateUrl: '/scripts/directives/changelog/cms.html',
        replace: true,
        transclude: true,
        scope: {
            options: "=",
        ...
        controller: ['$scope', '$changelogService','$log', '$filter', '$timeout', function($scope,changelogService, $log, $filter, $timeout) {
