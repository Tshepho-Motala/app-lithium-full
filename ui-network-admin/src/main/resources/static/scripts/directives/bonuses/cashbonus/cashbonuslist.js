...
angular.module('lithium').directive('cashBonusesList', function() {
    return {
        templateUrl:'scripts/directives/bonuses/cashbonus/cashbonuslist.html',
        scope: {
            data: '='
        },
        restrict: 'E',
        ...
        controller: ['$dt', '$translate', 'rest-casino', '$scope', 'DTOptionsBuilder', '$filter', 'notify',
            function($dt, $translate, casinoRest, $scope, DTOptionsBuilder, $filter, notify) {
                ...
                var baseUrl = "services/service-casino/backoffice/" + controller.data.user.domain.name + "/bonus/CASHBONUS/history?playerGuid=" + controller.data.user.guid;
