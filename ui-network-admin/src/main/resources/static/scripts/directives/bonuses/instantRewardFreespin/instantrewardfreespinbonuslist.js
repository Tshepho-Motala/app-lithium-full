...
angular.module('lithium').directive('instantRewardFreespinBonusesList', function() {
    return {
        templateUrl:'scripts/directives/bonuses/instantRewardFreespin/instantrewardfreespinbonuslist.html',
        scope: {
            data: '='
        },
        restrict: 'E',
