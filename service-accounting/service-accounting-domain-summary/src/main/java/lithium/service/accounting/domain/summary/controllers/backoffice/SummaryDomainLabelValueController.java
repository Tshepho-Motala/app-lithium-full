...
import lithium.service.accounting.domain.summary.services.SummaryDomainLabelValueService;
...
public class SummaryDomainLabelValueController {
	...
	public Response<List<SummaryDomainLabelValue>> find(@PathVariable("domainName") String domainName,
		...
		List<SummaryDomainLabelValue> result = service.find(domainName, granularity, accountCode, transactionType,
	...
	public Response<List<SummaryLabelValue>> findLimited(@PathVariable("domainName") String domainName,
		...
		List<SummaryLabelValue> result = service.findLimited(domainName, granularity, accountCode, transactionType,
