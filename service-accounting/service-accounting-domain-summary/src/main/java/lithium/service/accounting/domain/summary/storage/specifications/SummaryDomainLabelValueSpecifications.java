...
import lithium.service.accounting.domain.summary.storage.entities.LabelValue_;
import lithium.service.accounting.domain.summary.storage.entities.Label_;
...
import lithium.service.accounting.domain.summary.storage.entities.SummaryDomainLabelValue_;
...
public class SummaryDomainLabelValueSpecifications {
	...
	public static Specification<SummaryDomainLabelValue> find(final String domainName, final String currencyCode,
			final String accountCode, final String transactionTypeCode, final String labelName, final String labelValue,
			final int granularity, final Date dateStart, final Date dateEnd) {
