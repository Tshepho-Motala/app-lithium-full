...
import lithium.service.accounting.domain.summary.services.SummaryDomainService;
...
public class SummaryDomainAccountCodeController {
	...
	public Response<List<SummaryDomain>> find(@PathVariable("domainName") String domainName,
		...
		List<SummaryDomain> result = service.find(domainName, granularity, accountCode, currency);
	...
	public Response<List<SummaryDomainType>> findLast(@PathVariable("domainName") String domain,
		...
		List<SummaryDomainType> result = service.findLast(domain, last, granularity, accountCode, currency);
	...
	public Response<List<SummaryDomainType>> findLimited(@PathVariable("domainName") String domainName,
		...
		List<SummaryDomainType> result = service.findLimited(domainName, granularity, accountCode, currency, dateStart,
				dateEnd);
		return Response.<List<SummaryDomainType>>builder()
				.data(result)
				.status(Response.Status.OK)
