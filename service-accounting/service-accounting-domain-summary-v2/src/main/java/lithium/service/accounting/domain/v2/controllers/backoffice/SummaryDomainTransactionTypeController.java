...
import lithium.service.accounting.domain.v2.services.SummaryDomainTransactionTypeService;
...
public class SummaryDomainTransactionTypeController {
	...
	public Response<List<SummaryDomainTransactionType>> find(@PathVariable("domainName") String domainName,
		...
		List<SummaryDomainTransactionType> result = service.find(domainName, testUsers, granularity, accountCode, transactionType,
					currency);
	...
	public Response<List<SummaryTransactionType>> findLimited(@PathVariable("domainName") String domainName,
		...
		List<SummaryTransactionType> result = service.findLimited(domainName, testUsers, granularity, accountCode, transactionType,
