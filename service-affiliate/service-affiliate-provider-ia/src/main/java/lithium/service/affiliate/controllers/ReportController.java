...
import lithium.service.affiliate.data.repositories.*;
...
@RestController
@RequestMapping("/report/ia/{reportId}")
public class ReportController {
	...
	@Autowired
	ReportActionLabelValueService reportActionLabelValueService;
	@Autowired
	...
	public Response<Report> editPost(
		...
		edit.setGranularity(editReport.getPlayerDataPeriod());
		edit.setGranularityOffset((editReport.getPlayerDataPeriodOffset() != null)? editReport.getPlayerDataPeriodOffset(): 0);
		...
		edit.setGgrPercentageDeduction(editReport.getGgrPercentageDeduction());
