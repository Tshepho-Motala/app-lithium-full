...
//	private void processGRDs(Group g, JWTDomain jwtDomain) {
//		g.getGrds().forEach(grd -> {
//			log.info("grd : "+grd.getRole().getRole()
...
//				.id(domain.getId())
				...
				.ecosystemRelationshipType(cachingServices.findEcosystemRelationshipTypeByDomainNameShort(domain.getName()))
				.build();
