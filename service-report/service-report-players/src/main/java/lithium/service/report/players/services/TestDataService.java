...
//			Report report = Report.builder().name("players_yesterday").createdBy(User.systemGuid)
...
//			Report report = Report.builder().name("players_lastmonth").createdBy(User.systemGuid)
...
//
//		report = Report.builder().name("players every 5 minutes").createdBy(User.systemGuid)
