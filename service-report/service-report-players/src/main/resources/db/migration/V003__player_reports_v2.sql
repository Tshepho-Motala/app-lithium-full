ALTER TABLE `report_revision` ADD COLUMN `all_filters_applicable` BIT(1);
ALTER TABLE `report_action` 
DROP COLUMN `parameter1`,
DROP COLUMN `parameter2`,
DROP COLUMN `parameter3`,
DROP COLUMN `parameter4`,
DROP COLUMN `parameter5`,
DROP COLUMN `parameter6`;

-- MySQL dump 10.13  Distrib 5.7.12, for osx10.9 (x86_64)
--
-- Host: 127.0.0.1    Database: lithium_report_players
-- ------------------------------------------------------
...
-- Dump completed on 2017-08-15 11:11:39
