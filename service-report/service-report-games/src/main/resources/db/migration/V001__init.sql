...
--
-- Host: 127.0.0.1    Database: lithium_report_games
-- ------------------------------------------------------
...
-- Dump completed on 2017-11-13 15:31:52
...
-- Dump completed on 2017-11-13 15:31:51
...
CREATE TABLE `report_run_results` (
  ...
  `provider_id_id` bigint(20) DEFAULT NULL,
  `provider_name_id` bigint(20) DEFAULT NULL,
  `report_run_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_internal_id` (`internal_id`),
  KEY `FK2bwwre6p6813ie6aurr50chlu` (`name_id`),
  KEY `FK3a5ah9u201331s7guay3wvskd` (`provider_id_id`),
  KEY `FKj6gh62w5fao78pj0agj4odt4c` (`provider_name_id`),
  KEY `FKonp4ebvgtk1carn6e0f69mvuw` (`report_run_id`),
  CONSTRAINT `FK2bwwre6p6813ie6aurr50chlu` FOREIGN KEY (`name_id`) REFERENCES `string_value` (`id`),
  CONSTRAINT `FK3a5ah9u201331s7guay3wvskd` FOREIGN KEY (`provider_id_id`) REFERENCES `string_value` (`id`),
  CONSTRAINT `FKj6gh62w5fao78pj0agj4odt4c` FOREIGN KEY (`provider_name_id`) REFERENCES `string_value` (`id`),
...
-- Dump completed on 2017-11-13 15:31:53
