package lithium.service.user.provider.sphonic.idin.jobs;
...
import lithium.service.user.provider.sphonic.idin.storage.repositories.AuthenticationRepository;
...
public class AuthenticationJob {
	...
	@Autowired private ServiceUserProviderSphonicIdinModuleInfo moduleInfo;
