...
public class RegisterV4Controller {
  ...
  @PostMapping("/frontend/{domainName}/register/v4")
  public OAuth2AccessToken create(
      @PathVariable("domainName") String domainName,
      @Valid @RequestBody PlayerBasic playerBasic,
    ...
    playerBasic.setDomainName(domainName);
    localeContextProcessor.setLocaleContextHolder(locale, domainName);
    return signupService.registerV4Player(playerBasic, request, authorization);
  }
}
