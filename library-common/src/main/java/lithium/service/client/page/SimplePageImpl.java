package lithium.service.client.page;
...
public class SimplePageImpl<T> implements Page<T> {
	...
	public SimplePageImpl(@JsonProperty("content") List<T> content, @JsonProperty("page") int number, @JsonProperty("size") int size, @JsonProperty("totalElements") long totalElements) {
