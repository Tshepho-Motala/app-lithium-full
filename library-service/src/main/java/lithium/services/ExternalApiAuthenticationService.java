...
@Service
@Slf4j
public class ExternalApiAuthenticationService {
	...
	private String getSecretKey(String apiAuthorizationId) throws Status401UnAuthorisedException {
		Optional<LithiumConfigurationProperties.ExternalApiAuthorization> publicApiAuthorization =
			properties.getExternalApiAuthorizations().stream()
