...
-- Dump completed on 2017-06-01  9:52:31
...
--
-- Table structure for table `access_rule_type`
--

DROP TABLE IF EXISTS `access_rule_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `access_rule_type` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2017-06-01  9:52:30
...
CREATE TABLE `access_rule` (
  ...
  `enabled` bit(1) NOT NULL,
  `name` varchar(255) NOT NULL,
  `access_rule_type_id` bigint(20) NOT NULL,
  `domain_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKg86p9p5udak095875y6c8uxys` (`access_rule_type_id`),
  ...
  CONSTRAINT `FKg86p9p5udak095875y6c8uxys` FOREIGN KEY (`access_rule_type_id`) REFERENCES `access_rule_type` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
