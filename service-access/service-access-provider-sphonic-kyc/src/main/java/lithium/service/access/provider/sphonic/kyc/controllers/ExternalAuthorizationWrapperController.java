package lithium.service.access.provider.sphonic.kyc.controllers;
...
import lithium.service.access.provider.sphonic.kyc.services.KYCService;
...
public class ExternalAuthorizationWrapperController implements ExternalAuthorizationClient {
    @Autowired private KYCService service;
