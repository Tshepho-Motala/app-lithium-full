...
import lithium.service.access.provider.sphonic.kyc.config.ServiceAccessProviderSphonicKYCConfigurationProperties;
...
@EnableScheduling
@EnableConfigurationProperties(ServiceAccessProviderSphonicKYCConfigurationProperties.class)
...
@EnableJpaRepositories(
    value = {
        ...
        "lithium.service.access.provider.sphonic.kyc.storage.repositories"
    }
)
public class ServiceAccessProviderSphonicKYCApplication extends LithiumServiceApplication {
    public static void main(String[] args) {
        LithiumShutdownSpringApplication.run(ServiceAccessProviderSphonicKYCApplication.class, args);
    }
}
