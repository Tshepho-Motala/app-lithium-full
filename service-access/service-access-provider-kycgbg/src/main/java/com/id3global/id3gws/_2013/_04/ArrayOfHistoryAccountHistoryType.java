...
public class ArrayOfHistoryAccountHistoryType {

    @XmlElement(name = "History.AccountHistory", nillable = true)
    protected List<HistoryAccountHistoryType> historyAccountHistory;
     ...
     * {@link HistoryAccountHistoryType }
     * 
     * 
     */
    public List<HistoryAccountHistoryType> getHistoryAccountHistory() {
        if (historyAccountHistory == null) {
            historyAccountHistory = new ArrayList<HistoryAccountHistoryType>();
        }
