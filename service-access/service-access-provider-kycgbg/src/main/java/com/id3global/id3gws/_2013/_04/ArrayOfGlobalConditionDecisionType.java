...
public class ArrayOfGlobalConditionDecisionType {

    @XmlElement(name = "GlobalConditionDecision", nillable = true)
    protected List<GlobalConditionDecisionType> globalConditionDecision;
     ...
     * {@link GlobalConditionDecisionType }
     * 
     * 
     */
    public List<GlobalConditionDecisionType> getGlobalConditionDecision() {
        if (globalConditionDecision == null) {
            globalConditionDecision = new ArrayList<GlobalConditionDecisionType>();
        }
