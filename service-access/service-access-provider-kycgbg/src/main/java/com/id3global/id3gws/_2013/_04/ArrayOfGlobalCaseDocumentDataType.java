...
public class ArrayOfGlobalCaseDocumentDataType {

    @XmlElement(name = "GlobalCaseDocumentData", nillable = true)
    protected List<GlobalCaseDocumentDataType> globalCaseDocumentData;
     ...
     * {@link GlobalCaseDocumentDataType }
     * 
     * 
     */
    public List<GlobalCaseDocumentDataType> getGlobalCaseDocumentData() {
        if (globalCaseDocumentData == null) {
            globalCaseDocumentData = new ArrayList<GlobalCaseDocumentDataType>();
        }
