...
public class ArrayOfGlobalExternalDataResultParameterType {

    @XmlElement(name = "GlobalExternalDataResultParameter", nillable = true)
    protected List<GlobalExternalDataResultParameterType> globalExternalDataResultParameter;
     ...
     * {@link GlobalExternalDataResultParameterType }
     * 
     * 
     */
    public List<GlobalExternalDataResultParameterType> getGlobalExternalDataResultParameter() {
        if (globalExternalDataResultParameter == null) {
            globalExternalDataResultParameter = new ArrayList<GlobalExternalDataResultParameterType>();
        }
