...
public class ArrayOfGlobalPEPTierType {

    @XmlElement(name = "GlobalPEPTier", nillable = true)
    protected List<GlobalPEPTierType> globalPEPTier;
     ...
     * {@link GlobalPEPTierType }
     * 
     * 
     */
    public List<GlobalPEPTierType> getGlobalPEPTier() {
        if (globalPEPTier == null) {
            globalPEPTier = new ArrayList<GlobalPEPTierType>();
        }
