...
public class ArrayOfGlobalOrganisationType {

    @XmlElement(name = "GlobalOrganisation", nillable = true)
    protected List<GlobalOrganisationType> globalOrganisation;
     ...
     * {@link GlobalOrganisationType }
     * 
     * 
     */
    public List<GlobalOrganisationType> getGlobalOrganisation() {
        if (globalOrganisation == null) {
            globalOrganisation = new ArrayList<GlobalOrganisationType>();
        }
