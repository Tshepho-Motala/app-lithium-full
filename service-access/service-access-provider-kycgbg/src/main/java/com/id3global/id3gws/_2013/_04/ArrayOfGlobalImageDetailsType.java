...
public class ArrayOfGlobalImageDetailsType {

    @XmlElement(name = "GlobalImageDetails", nillable = true)
    protected List<GlobalImageDetailsType> globalImageDetails;
     ...
     * {@link GlobalImageDetailsType }
     * 
     * 
     */
    public List<GlobalImageDetailsType> getGlobalImageDetails() {
        if (globalImageDetails == null) {
            globalImageDetails = new ArrayList<GlobalImageDetailsType>();
        }
