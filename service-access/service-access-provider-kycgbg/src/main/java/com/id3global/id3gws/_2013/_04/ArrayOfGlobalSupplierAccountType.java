...
public class ArrayOfGlobalSupplierAccountType {

    @XmlElement(name = "GlobalSupplierAccount", nillable = true)
    protected List<GlobalSupplierAccountType> globalSupplierAccount;
     ...
     * {@link GlobalSupplierAccountType }
     * 
     * 
     */
    public List<GlobalSupplierAccountType> getGlobalSupplierAccount() {
        if (globalSupplierAccount == null) {
            globalSupplierAccount = new ArrayList<GlobalSupplierAccountType>();
        }
