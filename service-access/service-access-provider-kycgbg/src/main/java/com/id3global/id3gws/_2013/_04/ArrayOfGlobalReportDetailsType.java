...
public class ArrayOfGlobalReportDetailsType {

    @XmlElement(name = "GlobalReportDetails", nillable = true)
    protected List<GlobalReportDetailsType> globalReportDetails;
     ...
     * {@link GlobalReportDetailsType }
     * 
     * 
     */
    public List<GlobalReportDetailsType> getGlobalReportDetails() {
        if (globalReportDetails == null) {
            globalReportDetails = new ArrayList<GlobalReportDetailsType>();
        }
