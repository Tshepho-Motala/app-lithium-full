...
public class ArrayOfGlobalResultDataType {

    @XmlElement(name = "GlobalResultData", nillable = true)
    protected List<GlobalResultDataType> globalResultData;
     ...
     * {@link GlobalResultDataType }
     * 
     * 
     */
    public List<GlobalResultDataType> getGlobalResultData() {
        if (globalResultData == null) {
            globalResultData = new ArrayList<GlobalResultDataType>();
        }
