...
public class ArrayOfGlobalReportParameterType {

    @XmlElement(name = "GlobalReportParameter", nillable = true)
    protected List<GlobalReportParameterType> globalReportParameter;
     ...
     * {@link GlobalReportParameterType }
     * 
     * 
     */
    public List<GlobalReportParameterType> getGlobalReportParameter() {
        if (globalReportParameter == null) {
            globalReportParameter = new ArrayList<GlobalReportParameterType>();
        }
