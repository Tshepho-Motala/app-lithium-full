...
public class GetAccountPermissionResponseElement {

    @XmlElement(name = "GetAccountPermissionResult")
    @XmlSchemaType(name = "string")
    protected GlobalPermissionType getAccountPermissionResult;
     ...
     *     
     */
    public GlobalPermissionType getGetAccountPermissionResult() {
     ...
     *     
     */
    public void setGetAccountPermissionResult(GlobalPermissionType value) {
