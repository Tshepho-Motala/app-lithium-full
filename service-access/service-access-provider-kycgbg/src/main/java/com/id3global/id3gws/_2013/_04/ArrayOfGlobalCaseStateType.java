...
public class ArrayOfGlobalCaseStateType {

    @XmlElement(name = "GlobalCaseState", nillable = true)
    protected List<GlobalCaseStateType> globalCaseState;
     ...
     * {@link GlobalCaseStateType }
     * 
     * 
     */
    public List<GlobalCaseStateType> getGlobalCaseState() {
        if (globalCaseState == null) {
            globalCaseState = new ArrayList<GlobalCaseStateType>();
        }
