...
public class ArrayOfGlobalFCRAMatchDetailsType {

    @XmlElement(name = "GlobalFCRAMatchDetails", nillable = true)
    protected List<GlobalFCRAMatchDetailsType> globalFCRAMatchDetails;
     ...
     * {@link GlobalFCRAMatchDetailsType }
     * 
     * 
     */
    public List<GlobalFCRAMatchDetailsType> getGlobalFCRAMatchDetails() {
        if (globalFCRAMatchDetails == null) {
            globalFCRAMatchDetails = new ArrayList<GlobalFCRAMatchDetailsType>();
        }
