...
public class ArrayOfGlobalCreditHeaderAccountTypeType {

    @XmlElement(name = "GlobalCreditHeaderAccountType", nillable = true)
    protected List<GlobalCreditHeaderAccountTypeType> globalCreditHeaderAccountType;
     ...
     * {@link GlobalCreditHeaderAccountTypeType }
     * 
     * 
     */
    public List<GlobalCreditHeaderAccountTypeType> getGlobalCreditHeaderAccountType() {
        if (globalCreditHeaderAccountType == null) {
            globalCreditHeaderAccountType = new ArrayList<GlobalCreditHeaderAccountTypeType>();
        }
