...
public class ArrayOfGlobalDocumentCategorySubmissionTypeType {

    @XmlElement(name = "GlobalDocumentCategorySubmissionType", nillable = true)
    protected List<GlobalDocumentCategorySubmissionTypeType> globalDocumentCategorySubmissionType;
     ...
     * {@link GlobalDocumentCategorySubmissionTypeType }
     * 
     * 
     */
    public List<GlobalDocumentCategorySubmissionTypeType> getGlobalDocumentCategorySubmissionType() {
        if (globalDocumentCategorySubmissionType == null) {
            globalDocumentCategorySubmissionType = new ArrayList<GlobalDocumentCategorySubmissionTypeType>();
        }
