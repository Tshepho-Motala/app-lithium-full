...
public class ArrayOfGlobalPropertyType {

    @XmlElement(name = "GlobalProperty", nillable = true)
    protected List<GlobalPropertyType> globalProperty;
     ...
     * {@link GlobalPropertyType }
     * 
     * 
     */
    public List<GlobalPropertyType> getGlobalProperty() {
        if (globalProperty == null) {
            globalProperty = new ArrayList<GlobalPropertyType>();
        }
