...
public class ArrayOfGlobalSupplierType {

    @XmlElement(name = "GlobalSupplier", nillable = true)
    protected List<GlobalSupplierType> globalSupplier;
     ...
     * {@link GlobalSupplierType }
     * 
     * 
     */
    public List<GlobalSupplierType> getGlobalSupplier() {
        if (globalSupplier == null) {
            globalSupplier = new ArrayList<GlobalSupplierType>();
        }
