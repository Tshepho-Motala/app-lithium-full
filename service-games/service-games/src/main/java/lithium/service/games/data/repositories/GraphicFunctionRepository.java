...
public interface GraphicFunctionRepository extends PagingAndSortingRepository<GraphicFunction, Long> {
	...
	@CacheEvict(value="lithium.service.games.data.entities.GraphicFunction.findByName")
	@Override
	public <S extends GraphicFunction> S save(S arg0);
	
	@Cacheable(value="lithium.service.games.data.entities.GraphicFunction.findByName", unless="#result == null")
