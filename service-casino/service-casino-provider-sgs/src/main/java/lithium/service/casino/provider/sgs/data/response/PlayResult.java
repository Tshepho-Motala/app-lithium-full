...
public class PlayResult<E extends Extinfo> extends Result<E> implements Serializable {
	private static final long serialVersionUID = 1L;
	
	public PlayResult(String seq, String token, String balance, String bonusBalance, String extTransactionId) {
		super(seq, token);
