...
public class ValidateSessionService {
    ...
    public ValidateSessionResponse validateSession(Principal principal, String locale) throws
            ...
            Status490SoftSelfExclusionException, Status500UserInternalSystemClientException,
            Status405UserDisabledException, Status496PlayerCoolingOffException {
        ...
        userApiInternalClientService.performUserChecks(util.guid(), locale, util.sessionId(),
                true,true, false);
