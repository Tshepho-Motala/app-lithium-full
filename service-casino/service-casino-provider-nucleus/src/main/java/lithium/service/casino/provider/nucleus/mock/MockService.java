package lithium.service.casino.provider.nucleus.mock;
...
import lithium.service.casino.provider.nucleus.data.request.*;
...
public class MockService {
	...
	private BrandsConfigurationBrand getProviderConfig(final String domainName) {
		BrandsConfigurationBrand brandConfiguration = nucleusService.getBrandConfiguration(applicationName, domainName);
