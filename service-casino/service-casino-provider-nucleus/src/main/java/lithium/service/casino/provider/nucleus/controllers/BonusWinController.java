...
import lithium.service.casino.provider.nucleus.data.requestresponse.BonusWinRequestResponse;
...
//			br.setGameGuid(apiAuthentication.getProviderUrl()+"/"+bonusId);
			...
			BetResponse betResponse = nucleusService.getCasinoService().handleBetRequest(br);
