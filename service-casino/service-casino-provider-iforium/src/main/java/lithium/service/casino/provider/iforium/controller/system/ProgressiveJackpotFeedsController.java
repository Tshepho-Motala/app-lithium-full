package lithium.service.casino.provider.iforium.controller.system;
...
import lithium.service.casino.provider.iforium.service.progressivejackpotfeeds.ProgressiveJackpotFeedService;
...
public class ProgressiveJackpotFeedsController implements ProgressiveJackpotFeedsClient {
    @Autowired
    ...
    public ProgressiveJackpotFeedResponse getProgressiveJackpotFeeds(
        ...
        return progressiveJackpotFeedService.getProgressiveJackpotFeed(gameSupplier, domainName, game);
    }
}
