...
public class RollBackBetRequest extends GameRoundRequest{

    @JsonProperty("OriginalBetGameRoundTransactionID")
    @NotEmpty
    @Size(max = 50)
    private String originalBetGameRoundTransactionId;
