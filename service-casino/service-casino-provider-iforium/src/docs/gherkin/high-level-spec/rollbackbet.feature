Feature: ROLLBACKBET-HighLevel

  # This represents a high-level specification for the ROLLBACKBET feature. A detailed implementation would require detailed definitions for:
  #  # - WELL-FORMED and VALID requests
  #  # - SUCCESS and FAILURE Responses

  # ----------------------------------------------------------------------------
  Scenario: Success (0)
    Given a ROLLBACKBET request is WELL-FORMED and VALID
    ...
    """
    {
        ...
        "GameRoundID": "13245Z",
        "OrginalBetGameRoundTransactionID": "123456A",
    ...
    Then a ROLLBACKBET response is returned
  ...
  Scenario: Success (0) with optional parameters
    ...
    """
    {
        ...
        "OperatorAccountID": "livescorebetUK/TestOperatorID",
        "GameRoundID": "23245Z",
        "OrginalBetGameRoundTransactionID": "223456A",
  ...
  # ----------------------------------------------------------------------------
  Scenario: Failure (-8) when reversalTransactionId does not exist
    Given a ROLLBACKBET request is WELL-FORMED and VALID
    And the OperatorAccountID exists
    ...
    """
    {
        ...
        "OperatorAccountID": "livescorebetUK/TestOperatorID",
        "GameRoundID": "23245Z",
        "OrginalBetGameRoundTransactionID": "323456A",
  ...
  Scenario: Failure (-6) when request is not well formed
    Given a ROLLBACKBET request is NOT WELL-FORMED
  ...
  Scenario: Failure (-15) when GameID is not valid
    Given a ROLLBACKBET request is WELL-FORMED
