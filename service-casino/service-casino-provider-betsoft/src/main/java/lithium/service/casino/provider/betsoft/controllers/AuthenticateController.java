...
import lithium.service.casino.provider.betsoft.data.requestresponse.AuthenticationRequestResponse;
...
public class AuthenticateController extends BaseController {
    ...
    AuthenticationRequestResponse auth(@RequestParam String token, @RequestParam String hash, APIAuthentication apiAuthentication) {
		...
		try {
			...
			Response<Boolean> authResponse = betsoftService.getCasinoService().authenticate(getUserGuidFromUserApiToken(token), getApiTokenFromUserApiToken(token));
