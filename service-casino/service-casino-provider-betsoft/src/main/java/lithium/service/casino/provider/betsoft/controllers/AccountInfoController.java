...
import lithium.service.casino.provider.betsoft.data.request.AccountInfoRequest;
import lithium.service.casino.provider.betsoft.data.requestresponse.AccountInfoRequestResponse;
import lithium.service.casino.provider.betsoft.data.response.AccountInfoResponse;
...
//	@Autowired
    ...
    AccountInfoRequestResponse info(@RequestParam String userId, @RequestParam String hash, APIAuthentication apiAuthentication) {
		...
		try {
			...
			lithium.service.casino.client.objects.response.AccountInfoResponse response = betsoftService.getCasinoService().handleAccountInfoRequest(userId, null);
			if(response == null) {
