...
import lithium.service.casino.provider.betsoft.data.requestresponse.BonusReleaseRequestResponse;
...
//
//		try {
//			BonusReleaseResponse result = mapper.map(betsoftService.getCasinoService()
