...
import lithium.service.casino.provider.betsoft.data.requestresponse.RefundRequestResponse;
...
//	RefundHandler handler;
    ...
    RefundRequestResponse refund(@RequestParam String userId, 
		...
		try {
			...
			RollbackTranResponse response = betsoftService.getCasinoService().rollbackTran(rollbackRequest);
