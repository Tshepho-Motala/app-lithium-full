...
import lithium.service.casino.provider.rival.data.GameInternal;
import lithium.service.casino.provider.rival.data.GameListInternal;
...
public class GameListController {
	...
	@Autowired
	protected RivalModuleInfo moduleInfo;
