...
CREATE TABLE `campaign` (
  ...
  `campaign_username` varchar(255) NOT NULL,
  `campaign_password` varchar(255) NOT NULL,
...
--
-- Dumping routines for database 'lithium_provider_cataboom_campaign'
--
...
-- Dump completed on 2019-07-02 13:54:24
