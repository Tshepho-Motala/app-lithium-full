...
--
-- Table structure for table `bet_request_kind`
--

-- DROP TABLE IF EXISTS `bet_request_kind`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8 */;
...
--
-- Table structure for table `bet_result_kind`
--

-- DROP TABLE IF EXISTS `bet_result_kind`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8 */;
...
--
-- Table structure for table `bet_round`
--

-- DROP TABLE IF EXISTS `bet_round`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8 */;
CREATE TABLE `bet_round` (
     ...
     `version` int(11) NOT NULL,
     `bet_result_id` bigint(20) DEFAULT NULL,
     `game_id` bigint(20) NOT NULL,
     `user_id` bigint(20) NOT NULL,
     PRIMARY KEY (`id`),
     UNIQUE KEY `idx_guid` (`guid`),
     KEY `FK5q9qokv9oujv9fbhyhw8batte` (`bet_result_id`),
     KEY `FK9s5dxcs97tvp2n3prs49ydhun` (`game_id`),
     KEY `FKbrpnq6ep9l85hfyn9m7vp1l74` (`user_id`),
     CONSTRAINT `FK5q9qokv9oujv9fbhyhw8batte` FOREIGN KEY (`bet_result_id`) REFERENCES `bet_result` (`id`),
...
-- Dump completed on 2021-02-24 10:33:40
