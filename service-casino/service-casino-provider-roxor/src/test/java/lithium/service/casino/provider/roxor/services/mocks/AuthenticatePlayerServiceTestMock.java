...
public class AuthenticatePlayerServiceTestMock {
    ...
    public static ValidationHelper mockNoLastLoginEvent() throws Exception {
        ValidationHelper validationHelper = Mockito.mock(ValidationHelper.class);
        Mockito.when(validationHelper.findLastLoginEventForSessionKey(Mockito.any(), Mockito.anyString())).thenReturn(null);
        return validationHelper;
    }

    public static ValidationHelper mockNotFoundGetUserGuidFromApiToken() {
        ValidationHelper validationHelper = Mockito.mock(ValidationHelper.class);
        Mockito.when(validationHelper.getUserGuidFromApiToken(Mockito.anyString())).thenReturn(null);
        return validationHelper;
    }
