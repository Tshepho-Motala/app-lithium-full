import CsvGeneratorProvider, { ExportConfig, ExportProgress, ExportStatus, GenerateResponse } from "@/core/interface/provider/CsvGeneratorProvider";

export default class CsvGeneratorProviderMock implements CsvGeneratorProvider {
