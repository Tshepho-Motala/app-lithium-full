...
export default class ApiBasicClient {
  // Send provider , can be many provider (axios or fetch)
  constructor(
    public userService: UserServiceInterface,
    public provider: AxiosInstance // (Add your provider type, can be different types, add '| FetchInstance' if want use fetch)
  ) {}
