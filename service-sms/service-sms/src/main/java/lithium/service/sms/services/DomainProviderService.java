...
import lithium.service.sms.data.repositories.DomainProviderPropertyRepository;
import lithium.service.sms.data.repositories.DomainProviderRepository;
...
public class DomainProviderService {
	...
	private List<DomainProviderProperty> propertiesProcessed(Long domainProviderId, boolean defaultValue) {
		...
		if (domainProviderProperties.size() == providerPropertiesSize) {
			...
			if ((domainProviderProperties.isEmpty()) && (domainProviderPropertiesDefault.isEmpty())) {
				return Collections.emptyList();
			} else if ((domainProviderProperties.isEmpty()) && (!domainProviderPropertiesDefault.isEmpty())) {
				return domainProviderPropertiesDefault;
			} else if ((!domainProviderProperties.isEmpty()) && (domainProviderPropertiesDefault.isEmpty())) {
				return domainProviderProperties;
			}
