...
public enum AutoWithdrawalRuleOperator {
  BETWEEN(0, "BETWEEN"),
  EQUALS(1, "EQUALS"),
  ...
  public static AutoWithdrawalRuleOperator fromOperator(String operator) {
    for (AutoWithdrawalRuleOperator o : AutoWithdrawalRuleOperator.values()) {
  ...
  @JsonCreator
  public static AutoWithdrawalRuleOperator fromId(Integer id) {
    for (AutoWithdrawalRuleOperator o : AutoWithdrawalRuleOperator.values()) {
