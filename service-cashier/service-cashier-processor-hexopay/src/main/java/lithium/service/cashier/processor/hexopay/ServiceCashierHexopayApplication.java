...
public class ServiceCashierHexopayApplication extends LithiumServiceProcessorApplication {

    public static void main(String[] args) {
        LithiumShutdownSpringApplication.run(ServiceCashierHexopayApplication.class, args);
    }
