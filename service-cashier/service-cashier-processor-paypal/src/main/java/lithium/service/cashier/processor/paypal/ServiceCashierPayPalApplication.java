...
public class ServiceCashierPayPalApplication extends LithiumServiceProcessorApplication {

    public static void main(String[] args) {
        LithiumShutdownSpringApplication.run(ServiceCashierPayPalApplication.class, args);
    }
