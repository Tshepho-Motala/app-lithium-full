...
@EnableRestTemplate
public class ServiceCashierInpayApplication extends LithiumServiceProcessorApplication {

    public static void main(String[] args) {
        LithiumShutdownSpringApplication.run(ServiceCashierInpayApplication.class, args);
    }
